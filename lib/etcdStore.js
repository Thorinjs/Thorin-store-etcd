  ...
  class ThorinEtcdStore extends thorin.Interface.Store {
    ...
    * */
    set(key, value, opt) {
      ...
      return this[client].set(key, value, opt);
    }
    ...
    * */
    get(key, opt) {
      return this[client].get(key, opt);
    }
    ...
    * */
    delete(key, _range) {
      return this[client].delete(key, (typeof _range === 'undefined' ? 1 : _range));
    }
    ...
    * */
    range(from, to, _type) {
      return this[client].range(from, to, _type);
    }
  }
